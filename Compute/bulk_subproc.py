...
params1 = [ # alpha, target_magnitude, A, gamma, c 
        # "-lrp [0.602,0.5,0.00,0.101,0.1]", "-lrp [0.602,0.5,0.00,0.101,0.1]", "-lrp [0.602,0.5,0.00,0.101,0.1]",
        # "-lrp [0.602,0.5,10.0,0.101,0.1]", "-lrp [0.602,0.5,10.0,0.101,0.1]", "-lrp [0.602,0.5,10.0,0.101,0.1]",
        "-lrp [0.602,1.0,0.0,0.101,0.1]", "-lrp [0.602,1.0,0.0,0.101,0.1]", "-lrp [0.602,1.0,0.0,0.101,0.1]", "-lrp [0.602,1.0,0.0,0.101,0.1]", "-lrp [0.602,1.0,0.0,0.101,0.1]",
