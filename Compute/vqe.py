...
from utils import TerminateThreeStep, TerminatePovSlope, TerminateThreeSMA, TerminateMinSlope, TerminateLnFit, TerminateLnFit10step, TerminateLnFit10stepRel
