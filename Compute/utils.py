...
def pathfilename_gen(pcname_:"string", input_txt_:"string")->"string , string , dict":
    ...
    input_txt_dum = re.split('-|_|\\.', input_txt_)
    ...
    pathfilename["source_text"] = os.path.join(abspath_data_dir, input_txt_)
