...
class UCC(EvolvedOperatorAnsatz):
    ...
    def __init__(
        ...
        *,
        ...
        self._trott_order = trott_order

        super().__init__(reps=reps, evolution=PauliTrotterEvolution(trotter_mode=Suzuki(order=self._trott_order, reps=1)), initial_state=initial_state)
